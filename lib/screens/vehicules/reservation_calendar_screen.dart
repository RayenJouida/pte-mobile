...
import 'vehicle_reservation_screen.dart';

class VehicleReservationCalendarScreen extends StatefulWidget {
  @override
  _VehicleReservationCalendarScreenState createState() =>
      _VehicleReservationCalendarScreenState();
}

class _VehicleReservationCalendarScreenState
    extends State<VehicleReservationCalendarScreen> {
  final VehicleService _vehicleService = VehicleService();
  List<VehicleEvent> _events = [];
  Set<DateTime> _unavailableDays = {};
  DateTime? _selectedDate;
  List<VehicleEvent> _eventsOnSelectedDate = [];
  ...
  void _showEventDetailsPopup(VehicleEvent event, DateTime selectedDate, {required bool isPastDate}) {
    showDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Vehicle Reservation Calendar'),
        backgroundColor: Theme.of(context).colorScheme.primary,
        elevation: 0,
  ...
  String _calculateDuration(VehicleEvent event) {
  ...
  String _getEventStatus(VehicleEvent event) {
  ...
  Widget _buildEventCard(VehicleEvent event, int index) {
